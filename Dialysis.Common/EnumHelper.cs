...
namespace Dialysis.Common
{
    public static class EnumHelper
    {
        ...
        public static ArrayList EnumToArrayList<TEnum>(bool isAddDefaultText)
        {
        ...
        /// <returns>转化后的ArrayList</returns>
        public static ArrayList EnumToArrayList<TEnum>(bool isAddDefaultText, string selectDefaultText)
        {
