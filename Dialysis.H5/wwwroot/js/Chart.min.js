...
(function () {
    ...
    var each = helpers.each = function (loopable, callback, self) {
        ...
        return {steps: numberOfSteps, stepValue: stepValue, min: graphMin, max: graphMin + (numberOfSteps * stepValue)}
    ...
    extend(Chart.Type.prototype, {
        initialize: function () {
            ...
            return this
        }, reflow: noop, render: function (reflow) {
            if (reflow) {
                this.reflow()
            }
            ...
            if (ChartElements.length > 0) {
                if (this.datasets && this.datasets.length > 1) {
                    ...
                    var tooltipLabels = [], tooltipColors = [], medianPosition = (function (index) {
                        ...
                        xMin = min(xPositions);
                        xMax = max(xPositions);
                        return {x: (xMin > this.chart.width / 2) ? xMin : xMax, y: (yMin + yMax) / 2}
                    }).call(this, dataIndex);
    ...
    Chart.Point = Chart.Element.extend({
        display: true, inRange: function (chartX, chartY) {
    ...
    Chart.MultiTooltip = Chart.Element.extend({
        initialize: function () {
            ...
            if (this.y - halfHeight < 0) {
                ...
                if (this.y + halfHeight > this.chart.height) {
    ...
    Chart.Scale = Chart.Element.extend({
        initialize: function () {
        ...
        }, calculateYRange: noop, drawingArea: function () {
            ...
            if (this.display) {
                ...
                each(this.xLabels, function (label, index) {
                    var xPos = this.calculateX(index) + aliasPixel(this.lineWidth), linePos = this.calculateX(index - (this.offsetGridLines ? 0.5 : 0)) + aliasPixel(this.lineWidth), isRotated = (this.xLabelRotation > 0), drawVerticalLine = this.showVerticalLines;
...
(function () {
    ...
    Chart.Type.extend({
        name: "Bar", defaults: defaultConfig, initialize: function (data) {
            ...
            helpers.extend(this.BarClass.prototype, {y: this.scale.endPoint, base: this.scale.endPoint});
            var newScaleProps = helpers.extend({height: this.chart.height, width: this.chart.width});
...
(function () {
    ...
    Chart.Type.extend({
        name: "Doughnut", defaults: defaultConfig, initialize: function (data) {
            this.segments = [];
            ...
            helpers.extend(this.SegmentArc.prototype, {x: this.chart.width / 2, y: this.chart.height / 2});
            this.outerRadius = (helpers.min([this.chart.width, this.chart.height]) - this.options.segmentStrokeWidth / 2) / 2;
            helpers.each(this.segments, function (segment) {
                segment.update({
...
(function () {
    ...
    Chart.Type.extend({
        name: "Line", defaults: defaultConfig, initialize: function (data) {
            ...
            helpers.each(data.datasets, function (dataset) {
                ...
                this.eachPoints(function (point, index) {
                    helpers.extend(point, {x: this.scale.calculateX(index), y: this.scale.endPoint});
                    point.save()
                }, this)
            }, this);
            this.render()
                ...
                if (this.options.bezierCurve) {
                    helpers.each(pointsWithValues, function (point, index) {
                        ...
                        if (point.controlPoints.outer.y > this.scale.endPoint) {
                            ...
                            if (point.controlPoints.outer.y < this.scale.startPoint) {
                        ...
                        if (point.controlPoints.inner.y > this.scale.endPoint) {
                            ...
                            if (point.controlPoints.inner.y < this.scale.startPoint) {
...
(function () {
    ...
    Chart.Type.extend({
        name: "PolarArea", defaults: defaultConfig, initialize: function (data) {
            this.segments = [];
            this.SegmentArc = Chart.Arc.extend({
                showStroke: this.options.segmentShowStroke,
                strokeWidth: this.options.segmentStrokeWidth,
            ...
            this.scale.update();
            helpers.extend(this.scale, {xCenter: this.chart.width / 2, yCenter: this.chart.height / 2});
            helpers.each(this.segments, function (segment) {
