...
namespace Dialysis.WebAdmin.Migrations
{
    ...
    [Migration("20170407030310_HandRing")]
    partial class HandRing
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("Dialysis.Domain.Models.BloodPressure", b =>
                {
                    ...
                    b.Property<int?>("DialysisBloodPressureId");
            ...
            modelBuilder.Entity("Dialysis.Domain.Models.BloodSugar", b =>
                {
                    b.Property<long>("Id");
            ...
            modelBuilder.Entity("Dialysis.Domain.Models.Dialysis", b =>
                {
                    ...
                    b.Property<int>("DialysisRecordId");
            ...
            modelBuilder.Entity("Dialysis.Domain.Models.Doctor", b =>
                {
                    ...
                    b.Property<string>("DialysisDoctorId")
                        .IsRequired()
                        .HasMaxLength(128);
            ...
            modelBuilder.Entity("Dialysis.Domain.Models.HandRing", b =>
                {
                    b.Property<long>("Id");
            ...
            modelBuilder.Entity("Dialysis.Domain.Models.Patient", b =>
                {
                    ...
                    b.Property<int>("DialysisPatientId");
            ...
            modelBuilder.Entity("Dialysis.Domain.Models.PatientContact", b =>
                {
                    b.Property<long>("Id");
                    ...
                    b.Property<string>("ContatctName")
                        .HasMaxLength(50);

                    b.Property<string>("Country")
                        .HasMaxLength(8);

                    b.Property<int>("DialysisContactId");
            ...
            modelBuilder.Entity("Dialysis.Domain.Models.Water", b =>
                {
                    b.Property<long>("Id");
            ...
            modelBuilder.Entity("Dialysis.Domain.Models.Weight", b =>
                {
                    ...
                    b.Property<int?>("DialysisWeightId");
            ...
            modelBuilder.Entity("Dialysis.Domain.Models.PatientEducationDetail", b =>
                {
                    ...
                    b.HasOne("Dialysis.Domain.Models.PatientEducation", "PatientEducation")
                        .WithMany("PatientEducationDetail")
